...
ssh -l s20691161 89.169.176.105
ssh -l s20691161 89.169.177.89
ssh -l s20691161 89.169.183.167
echo $HOSTNAME
sudo su
...
http://89.169.176.105:3000
for i in {1..10}; do curl http://89.169.176.105:3000; done
